            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link href="/" className="mb-8 inline-block">
                  <Image
                    src="/images/logo/img2-removebg-preview.png"
                    alt="logo"
                ...
                <p className="dark:text-body-color-dark mb-9 text-base leading-relaxed text-body-color">
                  Epibren is your one-stop tech partner for building fast, scalable, and user-centric web and mobile applications.
                </p>
                <div className="flex items-center">
                  <a
                    // href="/"
                    aria-label="social-link"
                    className="dark:text-body-color-dark mr-6 cursor-default text-body-color duration-300 hover:text-primary dark:hover:text-primary"
                  >
                    <svg
                      width="9"
                      height="18"
                  ...
                  <a
                    // href="/"
                    aria-label="social-link"
                    className="dark:text-body-color-dark cursor-default text-body-color duration-300 hover:text-primary dark:hover:text-primary"
                  >
                    <svg
                      width="17"
                      height="16"
